...
/*
                ...
                AD5592R Library Example: Setting DAC voltage via the serial ports
...
void setup() {
    ...
    DAC.setup_supply_voltage_mV(VDD);
    ...
    DAC.setup_dac_all_pins(255);		//Setting all pins as DAC
...
void retrieveVoltage() {
    ...
    if ((voltage_mV_set >= 0) && (voltage_mV_set <= VDD)) {
        ...
        bool DACResponse = DAC.dac_voltage_set_mV(AD5592R_IO(channel), voltage_mV_set);
